<%@ Page Title="" Language="C#" MasterPageFile="MP.master" AutoEventWireup="true" Inherits="WebSite.Fr.ListingPage2" %>
<asp:Content ID="Content2" ContentPlaceHolderID="cp" runat="server">
		<div class="d-md-none" id="btn-open-filter" data-toggle="collapse" data-target=".filters" title="Search filters">
			...
			<div v-if="promotions" class="promotions">
				<a v-for="promotion in promotions" class="row" :href="promotion.Url" style="color:black;margin-bottom: 20px;text-decoration: none">
					...
					<div class="col">
						...
						<span class="badge-pill badge-info" v-if="promotion.ValidOnlyOnline">Online only</span>
						<span class="badge-pill badge-info" v-if="promotion.ValidOnlyInStore">In store only</span>
						<br />
				...
				<div :id="p.Id" class="col-6 col-sm-4" v-for="p in listing.Products">
					<div class="single-product-flex">
						...
						<div class="proIcon">
							...
							<div v-if="p.DateAvailableAt" class="proPreOrder proMsg"> target {{formatDate(p.DateAvailableAt)}}</div>
						...
						<div class="promotion-detail" v-if="p.PromoShortInStore">
							...
							<div class="promo-flair"><div class="promo-location">In store only</div></div>
						</div>
