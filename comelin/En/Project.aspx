<%@ Page Title="Project" Language="C#" MasterPageFile="~/En/MP.Master" AutoEventWireup="true" Inherits="WebSite.Fr.Project" %>
		...
		<div class="row">
			...
			<div class="col-12 col-md-9">
				...
				<div id="go-to-top"><a href="#" onclick="window.scrollTo(0,0); return false;">
					<i class="fa fa-long-arrow-up" title="Move to top" style="max-height:20px"></i>
				</a></div>	
			</div>
			<div class="col-12">
