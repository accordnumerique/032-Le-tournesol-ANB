<%@ page  language="C#" masterpagefile="MP.master" autoeventwireup="true" inherits="WebSite.Fr._default"  %>
<asp:Content ID="Content2" ContentPlaceHolderID="cp" runat="server" >
	<%= HomePageModules %>
	</asp:Content>
<asp:Content runat="server" ContentPlaceHolderID="cpFooter">
<script src='https://unpkg.com/vueperslides@2.14.0/dist/vueperslides.umd.min.js'></script>                                                                                                                                                                                                                                                  <link href="https://unpkg.com/vueperslides/dist/vueperslides.css" rel="stylesheet">
