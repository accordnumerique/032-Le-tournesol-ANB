	...
	<body  style="background-image: url('images/bg.jpg'); background-repeat: repeat; background-color: #eaecee; font-family: Tahoma, Arial, Helvetica, Verdana, sans-serif;">
		<div align="center" id="appEmail">
						    ...
						    <table border="0" cellpadding="0" cellspacing="0"  style="background-color: #d0d0d0; width:100%">
							    <tr>
								    ...
								    <td align="right" width="200"><a href="<%= WebSite %>" style="display: block; width: 199px; height: 47px; background: url(images/button.png); text-align: center; line-height: 47px; 
								                                  	color: #555555; font-weight: 900; text-decoration: none; font-size: 16px;">Visitez le site web</a></td>
							    </tr>
									<tr style="background-color:White">
										<td colspan=2 align=center>
										 
									<img src="<%= Logo %>" alt="<%= CompanyName %>" height="100" style="height:100px; padding:5px" />		
										</td>
									</tr>
						    </table>
			...
			<p style="font-size: 12px; color: #999999; margin: 15px 0 0 0; line-height: 19px;">
				<br />Ce courriel à été envoyé à <%= Email %><br /> <a href="<%= WebSite %>" style="color: #2670c3; text-decoration: none;">Visitez notre site web</a>
				| <a href="/fr/Inscription-Journal.aspx" style="color: #2670c3; text-decoration: none;">Préférence de communication</a><br/></p>
		</div>
...
<script src="https://cdn.jsdelivr.net/npm/vue@2"></script>
  ...
  return (q[key] = value, q);
        ...
        var app = new Vue({
            ...
            computed: {
                urlBarcode: function() {
					return '/api/barcode?data={3:barcode}&width=200&height=50' + this.barcode;
                } 
            },
			mounted: function () {
